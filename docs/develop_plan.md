...
| 1.8 | 수업 전날 회원 안내 메시지 자동 발송 (M1) | High | Supabase Edge Function + cron |
| 1.9 | Firebase App Distribution / TestFlight 베타 배포 | High | 친구 디바이스에서 설치 성공 |

> **Phase 1 완료 정의(DoD):** 친구가 본인 회원 3~5명 데이터를 넣고 **1주일간 매일 사용**할 수 있다.
...
| Phase 1이 6주 초과 | Should 작업 전부 Phase 2로 미루고 Must만 마무리 후 베타 시작 |
