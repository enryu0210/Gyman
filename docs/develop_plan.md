...
- **Phase 4** 카메라/체형 AI(설계만 완료 — 0008 스키마 빚 정리 선행 필요).
...
| 4.2 | 체형 분석 (C3) — ⬜ **설계만 완료** | **결정 고정: 100% 온디바이스**(ML Kit Pose, 사진 외부전송 0, LLM·비용 0). 좌우 어깨/골반 비대칭 우선. 첫 등록 + 4·8·12주 비교. ⚠ 착수 전 0008 스키마 빚(`body_assessments.member_id` user_id→id) 정리 필요. 상세: `docs/design_body_analysis.md` |
