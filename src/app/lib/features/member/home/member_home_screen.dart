        ...
        child: Column(
          ...
          children: [
            ...
            if (session == null)
              ...
              Text(
                _formatKoreanDateTime(session!.scheduledAt),
              ...
              Text(
                _untilLabel(session!.scheduledAt),
                style: theme.textTheme.bodyMedium?.copyWith(
...
class _ContractRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final colors = Theme.of(context).colorScheme;
    final label =
        '${_formatDate(status.startDate)} 시작 계약';
    return Padding(
...
// =====================================================================
// 날짜 포맷 헬퍼 — intl 한국어 로케일 미초기화 대비 수동 구현
// =====================================================================
...
/// "2026-05-30" 형태 (계약 시작일 등 간단 표기용).
String _formatDate(DateTime dt) {
  String two(int n) => n.toString().padLeft(2, '0');
  return '${dt.year}-${two(dt.month)}-${two(dt.day)}';
}

/// 지금으로부터 남은 시간을 사람 친화적으로. ("3일 뒤", "오늘", "2시간 뒤")
