...
> ✅ **0001~0036 적용 완료** (0001~0034: 2026-07-06 / 0035·0036: 2026-07-25).
> ⬜ **0037·0038 적용 대기** — 적용 전엔 코칭 큐가 안 뜨고(규칙 0건) 영상 마킹은 조회 에러.
...
3. 파일 **0001부터 0038까지 번호 순서대로** 열어서 복사·붙여넣기·실행 (0012 제외 — 아래 5번)
...
1. 새 파일 추가: `0039_<설명>.sql` (번호는 마지막 파일 다음부터 증가 — 현재 마지막은 0038)
